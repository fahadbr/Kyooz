...
//		self.navigationItem.titleView = segmentedControl
	...
	private enum Content {
		...
		private static func collectionsListWithTweakStore(_ tweakStore: TweakStore, delegate: TweaksCollectionsListViewControllerDelegate) -> Content {
			return .collectionsList(TweaksCollectionsListViewController(tweakStore: tweakStore, delegate: delegate))
		}

		private static func backupsListWithTweaksStore(_ tweakStore: TweakStore, delegate: TweaksBackupsListViewControllerDelegate) -> Content {
