...
internal final class TweakTableCell: UITableViewCell {
	...
	override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
		...
		detailTextLabel!.textColor = ThemeHelper.defaultFontColor
	}
	...
	private func updateSubviews() {
		...
		textField.textColor = textFieldEnabled ? ThemeHelper.defaultFontColor : AppTheme.Colors.controlSecondary
